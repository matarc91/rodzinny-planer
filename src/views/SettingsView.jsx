        ...
        {expandedSection === 'notifications' && (
          <div className="p-4 pt-3 border-t border-[#33333C] space-y-4 bg-stone-900/40">
            ...
            {showSqlGuide && (
              <div className="bg-stone-900 p-4 rounded-xl border border-amber-500/30 text-xs text-stone-300 space-y-3">
                ...
                <p className="text-stone-300 leading-relaxed text-[11px]">
                  Gdy zamykasz aplikację, Twój telefon rejestruje token subskrypcji w tabeli{' '}
                  <code className="bg-stone-800 px-1 py-0.5 rounded text-amber-300">push_subscriptions</code> w
                  Supabase. Aby serwer Supabase sam wysyłał powiadomienia o terminach i wydarzeniach, uruchom plik{' '}
            ...
            <p className="text-[11px] text-stone-400 leading-relaxed bg-stone-900/70 p-3 rounded-xl border border-stone-800">
              <strong>Wskazówka (Działanie jak aplikacja ze sklepu):</strong> Na telefonie (Android / iPhone) w menu
              przeglądarki wybierz <span className="text-amber-400 font-medium">&quot;Dodaj do ekranu głównego&quot;</span> /{' '}
              <span className="text-amber-400 font-medium">&quot;Zainstaluj aplikację&quot;</span>. Dzięki temu system
              operacyjny traktuje aplikację jako PWA i nie ubija powiadomień w tle.
            </p>
          </div>
        )}
      </div>
      ...
      <div className="bg-[#1E1E22] border border-red-900/40 rounded-2xl overflow-hidden transition-all shadow-sm">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-stone-400">Odpięcie od rodziny, usuwanie konta lub usuwanie całej rodziny</div>
            </div>
          </div>
          <div className="text-stone-400 p-1">
        ...
        {expandedSection === 'danger' && (
          <div className="p-4 pt-3 border-t border-red-900/40 space-y-4 bg-red-950/10">
            {/* Opcja 1: Tylko odpięcie od rodziny */}
            <div className="space-y-2">
              <div className="text-xs font-semibold text-stone-200 flex items-center gap-1.5">
                <Users size={14} className="text-amber-400" /> Odpięcie od bieżącej rodziny (Opuść rodzinę)
              </div>
              <p className="text-xs text-stone-400 leading-relaxed">
                Odłącza Twoje konto od rodziny <strong className="text-stone-200">{family?.name}</strong>. Twoje konto
                użytkownika pozostanie aktywne, a aplikacja przekieruje Cię do menu dołączenia z kodem lub stworzenia nowej rodziny.
              </p>
              <button
                type="button"
              ...
              >
                <Users size={15} /> Odepnij się od rodziny i przejdź do wyboru
              </button>
            </div>
            ...
            <div className="space-y-2 pt-3 border-t border-red-900/30">
              ...
              <p className="text-xs text-stone-400 leading-relaxed">
                Spowoduje wyczyszczenie Twoich prywatnych notatek, odpięcie profilu od członka rodziny oraz wylogowanie
                z aplikacji.
              </p>
              <button
                type="button"
            ...
            {/* Opcja 3: Usuwanie całej rodziny */}
            <div className="space-y-2 pt-3 border-t border-red-900/30">
              <div className="text-xs font-semibold text-stone-200 flex items-center gap-1.5">
                <Trash2 size={14} className="text-red-400" /> Usuwanie całej rodziny
              </div>
              <p className="text-xs text-stone-400 leading-relaxed">
                Usunięcie rodziny spowoduje skasowanie całego wspólnego kalendarza, zadań, notatek i całej listy domowników
                z bazy.
              </p>
              <button
                type="button"
